...
module.exports = {
    name: ["search"],
    description: "Busca musica y reproducela pues",
    category: "Music",
    options: [
        {
            name: "search",
            type: ApplicationCommandOptionType.String,
            description: "La cancion a reproducirr",
            required: true
        }
    ],
    run: async (client, interaction) => {
        ...
        if (db.setup_enable === true) return interaction.reply("Nopodesestaraca");
        ...
        const embed = new EmbedBuilder()
            .setAuthor({ name: `Elige cual es el que es...`, iconURL: interaction.guild.iconURL({ dynamic: true }) })
